...
import { dataUriToBlob } from 'zeed';
  ...
  methods: {
    ...
    updateInput() {
      ...
      if (input) {
        ...
        input.style.width = `${
          value ? input.scrollWidth : this.initialWidth
        }px`;
    ...
    charAnimation() {
      setTimeout(() => {
        ...
        if (input) {
          ...
          this.updateInput();
          if (this.currentChar < this.defaultName.length) this.charAnimation();
        }
      }, 100);
    },
  },
    ...
    <div class="page1">
      <div class="logo">
        <form id="form" @submit.prevent="doEnterRoom">
          <div style="font-size: 3rem"> link to room: </div>
      ...
      <div class="footer links">
        <p>
          © 2023
          <a href="//louiscklaw.github.io/"> louis portfolio </a>
          <a href="//louiscklaw.github.io/"> (source) </a>
        </p>
      </div>
    </div>
  </div>
