...
const initialLocale = globalThis.isNodeTestEnv
  ? 'en'
...
log(
  `locale=${
    initialLocale || navigator?.language?.slice(0, 2)
...
export const _languageTag = globalThis.isNodeTestEnv
  ? ref('')
  : useLocalStorage('languageTag', '');
